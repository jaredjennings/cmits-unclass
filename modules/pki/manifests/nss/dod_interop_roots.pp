...
# \subsection{Install DoD interoperability root cert(s)}
#
# This defined resource type will install DoD interoperability root CA
# certificates into the named database. These offer a trust path to
# certificates issued outside the DoD. See
